    ...
    try {
      http.post(
        ...
        body: jsonEncode({
          ...
          'template_id': 'template_broken_link', 
          'user_id': 'PUBLIC_KEY_PLACEHOLDER', 
          'template_params': {
            'to_email': 'ben10show1999@gmail.com', 'video_title': videoTitle, 'quality': quality, 'broken_url': brokenUrl, 'deep_link': deepLink, 'report_time': DateTime.now().toIso8601String()
          }
        }),
      );
