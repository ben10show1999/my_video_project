...
class RemoteConfigService {
  static const String _gistUrl =
      "https://gist.githubusercontent.com/ben10show1999/db8d13db302f99095ed022da4cdfac47/raw/config.json"; // UPDATE THIS
  ...
  static Future<bool> fetchConfig() async {
    ...
    try {
      ...
      return false; // Strict handling, no local mock data fallback.
    }
  }
