...
class RemoteConfigService {
  ...
  static String? appLogoUrl; // Task 16: Dynamic Logo
  ...
  static void _parseData(Map<String, dynamic> data) {
    if (data['appConfig'] != null) { appLogoUrl = data['appConfig']['logoUrl']; }
  ...
  static void _loadFallbackData() {
    appLogoUrl = "https://iili.io/q2Ty8N4.webp";
