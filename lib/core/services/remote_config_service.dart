...
class RemoteConfigService {
  ...
  // Hybrid Security: Decrypts base64 encoded strings
  ...
  static void _parseData(Map<String, dynamic> data) {
    branding = AppBranding.fromJson(data['appConfig']);
  ...
  static void _loadFallbackData() {
    branding = AppBranding(mainLogoUrl: 'https://iili.io/q2Ty8N4.webp', playerLogoUrl: 'https://iili.io/q2Ty8N4.webp', splashLogoUrl: 'https://iili.io/q2Ty8N4.webp');
