...
class RemoteConfigService {
  ...
  static void _parseData(Map<String, dynamic> data) {
    if (data['appConfig'] != null) {
      appConfig = AppConfigModel.fromJson(data['appConfig']);
    }
    if (data['hero'] != null) {
  ...
  static void _loadFallbackData() {
    appConfig = AppConfigModel(
        mainLogoUrl: "https://iili.io/q2Ty8N4.webp",
        playerLogoUrl: "https://iili.io/q2Ty8N4.webp",
        splashLogoUrl: "https://iili.io/q2Ty8N4.webp");
