...
class RemoteConfigService {
  ...
  // Task 10: Hybrid Security - Decrypts base64 encoded strings
  ...
  static Future<bool> fetchConfig() async {
    ...
    try {
      final response = await http.get(Uri.parse(_gistUrl)).timeout(const Duration(seconds: 10));
  ...
  static void _parseData(Map<String, dynamic> data) {
    if (data['appConfig'] != null) { appConfig = AppConfigModel.fromJson(data['appConfig']); }
  ...
  static void _loadFallbackData() {
    appConfig = AppConfigModel(mainLogoUrl: "https://iili.io/q2Ty8N4.webp", playerLogoUrl: "https://iili.io/q2Ty8N4.webp", splashLogoUrl: "https://iili.io/q2Ty8N4.webp");
    heroData = HeroDataModel(title: "Flutter Series", posterUrl: "https://via.placeholder.com/1920x1080", targetId: "1", isExternal: false);
    homeSections = [SectionModel(title: "Trending", showTitles: true, items: [MovieSnippet(id: "1", imageUrl: "https://iili.io/fZAinLv.webp", title: "Fallback Movie")])];
    moviesDb["1"] = MovieModel(id: "1", title: "Fallback Movie", overview: "No Internet Connection.", posterPath: "https://iili.io/fZAinLv.webp", seasons: [SeasonModel(id: "s1", title: "Season 1", episodes: [EpisodeModel(id: "e1", title: "Ep 1", duration: "00:00", seasonNumber: 1, episodeNumber: 1, sources: [VideoQualityModel(quality: "Auto", urls: [""])])])]);
