...
class UniversalImage extends StatelessWidget {
  ...
  Widget _buildErrorWidget() {
    ...
    return Container(color: AppColors.surface, child: LayoutBuilder(builder: (context, constraints) => Center(child: Icon(Icons.broken_image_rounded, color: Colors.grey, size: constraints.maxWidth * 0.3))));
  }
}
