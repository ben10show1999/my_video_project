...
class AppNotification {
  ...
  Map<String, dynamic> toJson() => {
    'title': title, 'body': body, 'time': time, 'targetId': targetId, 'payload': payload, 'imageUrl': imageUrl
  };

  factory AppNotification.fromJson(Map<String, dynamic> json) => AppNotification(
    title: json['title'], body: json['body'], time: json['time'], targetId: json['targetId'], payload: json['payload'], imageUrl: json['imageUrl']
  );
}
...
class AppProvider extends ChangeNotifier {
  ...
  Future<void> _loadPrefs() async {
    ...
    if (_notificationsEnabled) {
      ...
      if (notifsString != null) {
        ...
        _notifications = [
           AppNotification(title: "New Arrival", body: "Check out the new season!", time: "2h ago", targetId: "1", payload: "movie_1", imageUrl: "https://via.placeholder.com/100")
        ];
        _saveNotifications();
      }
    }
  ...
  void scheduleReminder(String movieTitle) {
    ...
    Future.delayed(const Duration(seconds: 3), () {
      if (!_notificationsEnabled) return;
      final newNotif = AppNotification(title: "Reminder", body: "Watch: $movieTitle", time: "Just now", targetId: "1", payload: "movie_remind", imageUrl: "https://via.placeholder.com/100?text=R");
      _notifications.insert(0, newNotif);
      _saveNotifications(); // Save to persistence
      notifyListeners();
    });
  }
