...
class AppProvider extends ChangeNotifier {
  ...
  final Set<String> _myListIds = {}; List<String> get myListIds => _myListIds.toList(); // ✅ Changed to String
  ...
  Locale get locale {
    if (_languageCode == 'auto') {
      ...
      if (systemLoc == 'ar') { return const Locale('ar'); } else { return const Locale('en'); }
    }
  ...
  bool isInList(String id) => _myListIds.contains(id); // ✅ Changed to String
  void toggleMyList(String id) { // ✅ Changed to String
