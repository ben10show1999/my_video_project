  ...
  Future<void> _loadPrefs() async {
    ...
    if (_notificationsEnabled) {
      ...
      if (notifsString != null) {
        ...
        _notifications = [ AppNotification(title: "New Arrival", body: "Check out the new season!", time: "2h ago", targetId: "1", payload: "movie_1", imageUrl: "https://via.placeholder.com/100") ];
        _saveNotifications();
      }
    }
    notifyListeners();
