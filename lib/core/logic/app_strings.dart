class AppStrings {
  static const Map<String, Map<String, String>> _values = {
    'en': {
      ...
      'close': 'Close', 'close_ad': 'Close AD', 'delete': 'Delete',
      ...
      'cache_limit': 'Cache clear limit reached.', 'resume_msg': 'Resume video?', 'resume_btn': 'Resume'
    },
    'ar': {
      ...
      'close': 'إغلاق', 'close_ad': 'إغلاق الإعلان', 'delete': 'حذف',
      ...
      'report_subject': 'إبلاغ عن محتوى: ', 'best_link': 'جارٍ التبديل لرابط أسرع...',
      'link_fail': 'فشل الرابط، جارٍ تجربة التالي...', 'cooling_down': 'الشبكة غير مستقرة. سنحاول بعد قليل...',
      'cache_limit': 'تم الوصول للحد الأقصى لمسح الذاكرة.', 'resume_msg': 'استئناف الفديو؟', 'resume_btn': 'أستئناف'
    }
  };
