class AppStrings {
  static const Map<String, Map<String, String>> _values = {
    'en': {
      ...
      'added_list': 'Added to My List', 'removed_list': 'Removed from My List',
      'empty_list': 'Your list is empty', 'empty_notifs': 'No new notifications',
      'report_subject': 'Report Content: ',
      'best_link': 'Switching to faster link...', 'link_fail': 'Link failed, trying next...',
      ...
      'resume_btn': 'Resume', 'delete': 'Delete'
    },
    'ar': {
      ...
      'added_list': 'تمت الإضافة إلى قائمتي', 'removed_list': 'تمت الإزالة من قائمتي',
      'empty_list': 'قائمتك فارغة', 'empty_notifs': 'لا توجد إشعارات جديدة',
      'report_subject': 'إبلاغ عن محتوى: ',
      'best_link': 'جارٍ التبديل لرابط أسرع...', 'link_fail': 'فشل الرابط، جارٍ تجربة التالي...',
