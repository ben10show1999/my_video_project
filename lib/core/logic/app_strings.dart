class AppStrings {
  static const Map<String, Map<String, String>> _values = {
    'en': {
      ...
      'auto': 'Auto', 'en': 'English', 'ar': 'العربية',
      ...
      'added_list': 'Added to My List', 'removed_list': 'Removed from My List', 'empty_list': 'Your list is empty',
      'report_subject': 'Report Content: ', 'best_link': 'Switching to faster link...', 'link_fail': 'Link failed, trying next...',
      'close_ad': 'Close AD ×', 'ad_wait_net': 'Waiting for connection to resume Ad...'
    },
    'ar': {
      ...
      'auto': 'تلقائي', 'en': 'English', 'ar': 'العربية',
      ...
      'speed': 'السرعة', 'quality': 'الجودة', 'subtitles': 'ترجمة AI', 'enable_ai': 'تفعيل AI', 'back': 'رجوع',
      'wait_msg': 'حماية التسجيل نشطة. يرجى الانتظار...',
      'reminder_set': 'تم ضبط التذكير بنجاح!',
      'added_list': 'تمت الإضافة إلى قائمتي', 'removed_list': 'تمت الإزالة من قائمتي', 'empty_list': 'قائمتك فارغة',
      'report_subject': 'إبلاغ عن محتوى: ', 'best_link': 'جارٍ التبديل لرابط أسرع...', 'link_fail': 'فشل الرابط، جارٍ تجربة التالي...',
      'close_ad': 'إغلاق الإعلان ×', 'ad_wait_net': 'بانتظار الاتصال لاستئناف الإعلان...'
    }
  };
