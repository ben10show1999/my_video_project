...
class ThumbnailCache {
  ...
  static Future<Uint8List?> _extractFrame(String videoUrl) {
    ...
    void cleanup() {
      // ✅ FIX 1: Use null-aware operators (?.) for safely operating on captured nullable variables
    ...
    try {
      ...
      // We use a local non-nullable variable to safely configure the video initially
      ...
      currentVideo.setAttribute('disableRemotePlayback', 'true'); 
      currentVideo.src = videoUrl;

      currentVideo.onLoadedData.listen((_) { 
      ...
      currentVideo.onSeeked.listen((_) async {
        ...
        try {
          ...
          // ✅ FIX 2: Create local 'final' shadow variables. 
          // This allows Dart's strict flow analysis to promote them to non-nullable safely!
          final v = video;
          final c = canvas;
