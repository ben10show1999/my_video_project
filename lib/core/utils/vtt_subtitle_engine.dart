...
class VttSubtitleEngine {
  ...
  // Task 24: Smart Subtitle Fallback (System Lang -> "original" -> First Available)
  static Future<void> loadSubtitles(String requestedKey, Map<String, String> availableSubs) async {
    ...
    if (requestedKey == "Auto") {
      ...
      } else if (availableSubs.containsKey("original")) {
        url = availableSubs["original"]!;
      } else if (availableSubs.isNotEmpty) {
        url = availableSubs.values.first;
      }
    ...
    try {
      ...
      // Task 25: Async fetch to bypass UI Freeze and CORS limits
