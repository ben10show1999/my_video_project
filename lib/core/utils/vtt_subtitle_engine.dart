...
class VttSubtitleEngine {
  ...
  static final List<SubtitleCue> _cues = []; // ✅ Fixed: added final
  static bool _isLoading = false;
  static String _currentUrl = "";

  static final Map<String, String> _subtitleLinks = {
  ...
  static Future<void> loadSubtitles(String requestedLang) async {
    ...
    if (targetLang == "Auto") {
      ...
      if (_subtitleLinks.containsKey(sysLang)) { targetLang = sysLang; } else { targetLang = 'en'; }
    } else {
      targetLang = targetLang.substring(0, 2).toLowerCase();
    }

    final url = _subtitleLinks[targetLang];
