...
class AiSubtitleEngine {
  ...
  static void processVideo(String videoUrl, String requestedLang) {
    ...
    // ✅ Task 6: True System Locale Detection for "Auto"
    String targetLang = requestedLang;
    if (targetLang == "Auto") { targetLang = PlatformDispatcher.instance.locale.languageCode; } 
    else { targetLang = targetLang.substring(0, 2).toLowerCase(); }
