...
class MockData {
  ...
  static final List<MovieModel> allMovies = [
    MovieModel(id: 1, title: "Batal Al Alam (The Complete Project)", overview: "This is the 100% complete architecture including ALL screens, Stealth Service Worker, Float32Array AI, and Smart DRM.", posterPath: _img, seasons: [SeasonModel(id: "s1", title: "Season 1", episodes: [EpisodeModel(id: "s1e1", title: "Episode 1", duration: "45:00", seasonNumber: 1, episodeNumber: 1, sources: _ep1Sources)])]),
