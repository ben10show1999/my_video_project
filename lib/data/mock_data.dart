...
class MockData {
  ...
  static final List<MovieModel> allMovies = [
    ...
    ...List.generate(10, (i) => MovieModel(id: 10+i, title: "Movie ${i+1}", overview: "Overview for movie $i. This is a long description to test the expandable text feature which should show a button only if the text is long enough to overflow the container boundaries.", posterPath: _img, seasons: [])),
  ];
}
