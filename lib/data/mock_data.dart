...
class MockData {
  ...
  static final List<MovieModel> allMovies = [
    MovieModel(
      ...
      overview: "A test implementation using Vodu sources to verify the Intelligent Source Selector and Hybrid Adaptive Manager. This description is restored to ensure no details are lost.", 
      posterPath: _img, 
      year: "2024",
      rating: "PG-13",
    ...
    ...List.generate(10, (i) => MovieModel(id: 10+i, title: "Movie ${i+1}", overview: "Generated movie description...", posterPath: _img, year: "2023", rating: "R", genres: ["Comedy"], seasons: [])),
  ];
}
