...
class MockData {
  ...
  static final List<MovieModel> allMovies = [
    MovieModel(id: 1, title: "Batal Al Alam (The Ultimate Masterpiece)", overview: "All 10 Architectural Pillars Integrated: Phantom Warmup, Crypto-Stream, Smart DRM, Live AI Subtitles.", posterPath: _img, seasons: [SeasonModel(id: "s1", title: "Season 1", episodes: [EpisodeModel(id: "s1e1", title: "Episode 1", duration: "45:00", seasonNumber: 1, episodeNumber: 1, sources: _ep1Sources)])]),
