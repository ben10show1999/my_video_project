...
class MockData {
  ...
  static final List<MovieModel> allMovies = [
    MovieModel(
      id: 1, 
      title: "Batal Al Alam (The Ultimate Master)", 
      overview: "RepaintBoundary Isolation, Safe Multi-Threading, VTT Engine, Zero-Latency Resume, Point-In-Time Network Recovery, Smart Pulse Loader.", 
      posterPath: _img, 
      seasons: [
