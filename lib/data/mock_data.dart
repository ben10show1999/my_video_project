...
class MockData {
  ...
  // EPISODE 2 SOURCES (New Requested URLs)
  ...
  static final List<MovieModel> allMovies = [
    MovieModel(
      ...
      overview: "Absolute Master Build: Auto-Retry Thumbnails, Inline Ads, Strict Fullscreen Controls, Data Binding, Error Suppression.", 
      posterPath: _img, 
      seasons: [
