...
class MockData {
  ...
  static final List<MovieModel> allMovies = [
    MovieModel(
      id: 1, 
      title: "Batal Al Alam (The AI Masterpiece)", 
      overview: "Final Build: Transformers.js Web Worker Subtitles, Native Preloading, Media Session Annihilation, Anti-Piracy.", 
      posterPath: _img, 
      seasons: [
