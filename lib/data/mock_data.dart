...
class MockData {
  ...
  static final List<MovieModel> allMovies = [
    MovieModel(
      id: 1, 
      title: "Batal Al Alam (The Masterpiece Build)", 
      overview: "Final Build Corrected: Smart DRM Bridge, Live AI Subtitles, Rate-Limited Cache, Pure Proxy Media Session.", 
      posterPath: _img, 
      seasons: [
