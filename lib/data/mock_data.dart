...
class MockData {
  ...
  static final List<MovieModel> allMovies = [
    MovieModel(
      id: 1, 
      title: "Batal Al Alam (The Ultimate Matrix)", 
      overview: "Safe Multi-Threading COI, VTT Engine, Zero UI Lag RepaintBoundaries, Zero-Latency Resume, Point-In-Time Network Recovery, Smart Pulse Loader.", 
      posterPath: _img, 
      seasons: [
