...
class MovieModel { 
  final int id; final String title; final String overview; final String posterPath; 
  final String year; final String rating; final List<String> genres;
  final List<SeasonModel> seasons; 
  const MovieModel({required this.id, required this.title, required this.overview, required this.posterPath, required this.year, required this.rating, required this.genres, this.seasons = const []}); 
}
