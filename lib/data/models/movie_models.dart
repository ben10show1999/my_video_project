class VideoSourceModel {
  final String label;
  final String url;
  VideoSourceModel({required this.label, required this.url});
}
...
class EpisodeModel {
  ...
  EpisodeModel({
    ...
    required this.duration, required this.seasonNumber, required this.episodeNumber,
...
class MovieModel {
  ...
  const MovieModel({
    ...
    required this.posterPath, this.seasons = const [],
  });
}
