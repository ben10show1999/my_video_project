...
// �7�3 Unified Data Source
class MockDataRepository {
  static final List<MovieSnippet> allMovies = List.generate(20, (i) => MovieSnippet(id: "$i", imageUrl: "https://via.placeholder.com/300x450?text=Movie+$i", title: "Flutter Mastery Series Part $i"));
}
