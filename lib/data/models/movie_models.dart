...
class MovieModel { 
  ...
  final String? rating; final String? year; final String? contentRating; final String? infoIconUrl; final String? infoMessage;

  const MovieModel({required this.id, required this.title, required this.overview, required this.posterPath, this.seasons = const [], this.adScript, this.rating, this.year, this.contentRating, this.infoIconUrl, this.infoMessage}); 
  
  factory MovieModel.fromJson(Map<String, dynamic> json) => MovieModel(
    id: json['id'] ?? '', title: json['title'] ?? '', overview: json['overview'] ?? '', posterPath: json['posterPath'] ?? '', adScript: json['adScript'], 
    rating: json['rating'], year: json['year'], contentRating: json['contentRating'], infoIconUrl: json['infoIconUrl'], infoMessage: json['infoMessage'],
