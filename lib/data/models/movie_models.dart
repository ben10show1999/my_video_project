class AppBranding {
  ...
  AppBranding({required this.mainLogoUrl, required this.playerLogoUrl, required this.splashLogoUrl});
  factory AppBranding.fromJson(Map<String, dynamic>? json) => AppBranding(mainLogoUrl: json?['mainLogoUrl'] ?? 'https://iili.io/q2Ty8N4.webp', playerLogoUrl: json?['playerLogoUrl'] ?? 'https://iili.io/q2Ty8N4.webp', splashLogoUrl: json?['splashLogoUrl'] ?? 'https://iili.io/q2Ty8N4.webp');
}
