...
class EpisodeModel {
  ...
  EpisodeModel({required this.id, required this.title, this.thumbnailUrl, required this.duration, required this.seasonNumber, required this.episodeNumber, required this.sources, this.subtitles = const {}});
...
class MovieModel { 
  ...
  factory MovieModel.fromJson(Map<String, dynamic> json) => MovieModel(
    id: json['id'] ?? '', title: json['title'] ?? '', overview: json['overview'] ?? '', posterPath: json['posterPath'] ?? '', 
    adScript: json['adScript'], rating: json['rating'], releaseYear: json['releaseYear'], ageRating: json['ageRating'], 
