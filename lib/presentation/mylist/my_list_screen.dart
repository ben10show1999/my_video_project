      ...
      body: l.isEmpty ? Center(child: Text(p.tr('empty_list'), style: const TextStyle(color: Colors.grey))) : Padding(padding: const EdgeInsets.all(16), child: LayoutBuilder(builder: (c, cs) { 
        ...
        return GridView.builder(
          ...
          itemBuilder: (c, i) => InkWell(
            onTap: () => Navigator.push(c, MaterialPageRoute(builder: (_) => MovieDetailsScreen(movie: l[i]))), 
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start, 
              children: [
                ClipRRect(borderRadius: BorderRadius.circular(8), child: Container(color: const Color(0xFF1A1A1A), child: UniversalImage(path: l[i].posterPath))), 
