            ...
            child: LayoutBuilder(builder: (c, cs) { 
              ...
              return GridView.builder(
                ...
                itemBuilder: (c, i) => InkWell(
                  onTap: () async { 
                    if(RemoteConfigService.moviesDb.containsKey(l[i].id)){ 
                      await details_page.loadLibrary(); 
                      if(context.mounted) {
                        Navigator.push(c, MaterialPageRoute(builder: (_) => details_page.MovieDetailsScreen(movie: RemoteConfigService.moviesDb[l[i].id]!))); 
                      }
                    } 
                  }, 
                  child: Column(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: Container(color: const Color(0xFF1A1A1A), child: UniversalImage(path: l[i].imageUrl))
                      ), 
