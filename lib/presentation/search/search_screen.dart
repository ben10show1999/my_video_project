        ...
        Expanded(child: LayoutBuilder(builder: (c, cs) { 
          ...
          return GridView.builder(
            ...
            itemBuilder: (c, i) => InkWell(
              onTap: () => Navigator.push(c, MaterialPageRoute(builder: (_) => MovieDetailsScreen(movie: _filt[i]))), 
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start, 
                children: [
                  ClipRRect(borderRadius: BorderRadius.circular(8), child: Container(color: const Color(0xFF1A1A1A), child: UniversalImage(path: _filt[i].posterPath))), 
