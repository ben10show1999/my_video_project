...
class NotificationsScreen extends StatelessWidget { 
  ...
  @override Widget build(BuildContext context) { 
    ...
    final activeNotifs = manager.activeNotifications;
    return Scaffold(
                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        SizedBox(width: 100, height: 60, child: ClipRRect(borderRadius: BorderRadius.circular(4), child: n.imageUrl != null ? Container(color: const Color(0xFF1A1A1A), child: UniversalImage(path: n.imageUrl!, fit: BoxFit.cover)) : Container(color: Colors.white10, child: const Icon(Icons.notifications, color: AppColors.primary)))), 
