...
class SmartMediaKitPlayer extends StatefulWidget {
  ...
  final String videoTitle; // Added for Telemetry
...
class _SmartMediaKitPlayerState extends State<SmartMediaKitPlayer> {
  ...
  void _triggerFailover() {
    ...
    // ✅ Task 7: Silent Telemetry - Report Broken Link before failover
  ...
  @override Widget build(BuildContext context) { final p = Provider.of<AppProvider>(context); return LayoutBuilder(builder: (c, cs) { return MouseRegion(onHover: (_) => _startControlsTimer(), child: Stack(alignment: Alignment.center, children: [
    ...
    // ✅ Task 6: Pixel-Perfect Subtitles bound inside the AspectRatio
    Positioned.fill(
      child: AspectRatio(
          ...
          child: Padding(
            ...
            child: ValueListenableBuilder<String>(
              ...
              builder: (context, text, child) {
                ...
                // Dynamic scaling based on actual width
    ...
    // ✅ Task 8: Responsive Branding Watermark inside Player
    Positioned(
      top: 16, left: 16, 
      child: SafeArea(
        child: SizedBox(
          width: (cs.maxWidth * 0.06).clamp(30.0, 70.0), // Adaptive size
