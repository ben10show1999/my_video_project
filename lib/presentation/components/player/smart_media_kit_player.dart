...
class _SmartMediaKitPlayerState extends State<SmartMediaKitPlayer> {
  ...
  @override void initState() {
    ...
    // ✅ Task 7: Smart DRM Bridge Listeners (Only activates when recording is physically detected)
    ...
    player.stream.playing.listen((p) { 
      ...
      if (p) { _isSwitchingSource = false; _startControlsTimer(); } // Removed blind timer activation here
    });
  ...
  @override Widget build(BuildContext context) { final p = Provider.of<AppProvider>(context); return LayoutBuilder(builder: (c, cs) { return MouseRegion(onHover: (_) => _startControlsTimer(), child: Stack(alignment: Alignment.center, children: [
    ...
    // ✅ Task 6: Top-Tier Z-Index Invincible Overlay for Subtitles
    Positioned.fill(
      child: AspectRatio(
          ...
          child: Padding(
            ...
            child: ValueListenableBuilder<String>(
              ...
              builder: (context, text, child) {
                ...
                double fontSize = (cs.maxWidth * 0.035).clamp(14.0, 32.0); // Perfect Typography
                return Container(
