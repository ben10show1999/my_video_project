...
""";
  ...
  void _toggleFullscreen() async { 
    if (_isFullscreen) { 
      ...
      if (_currentRatio >= 1) {
         // Landscape (Wide Video)
         await SystemChrome.setPreferredOrientations([DeviceOrientation.landscapeLeft]); 
      } else {
         // Portrait (Vertical Video) - Maintain portrait but immersive
         await SystemChrome.setPreferredOrientations([DeviceOrientation.portraitUp]); 
      }
  ...
  @override Widget build(BuildContext context) { final p = Provider.of<AppProvider>(context); return AspectRatio(aspectRatio: _currentRatio, child: LayoutBuilder(builder: (c, cs) { return MouseRegion(onHover: (_) => _startControlsTimer(), child: GestureDetector(
  ...
  // CONTROLS WITH DECOUPLED SLIDER
