...
class _SmartMediaKitPlayerState extends State<SmartMediaKitPlayer> {
  ...
  // �7�3 NEW: Manual Fullscreen State
  ...
  void initState() {
    ...
    _connectivitySub = Connectivity().onConnectivityChanged.listen((result) {
       if (_isError && !result.contains(ConnectivityResult.none)) {
         debugPrint("�9�4 Connection restored. Auto-retrying...");
         _retryPlayback();
       }
    });
    ...
    player.stream.videoParams.listen((params) {
      ...
      if (w != null && h != null && h > 0) {
        _lastWidth = w.toDouble();
        _lastHeight = h.toDouble();
        widget.onAspectRatioChanged(_lastWidth / _lastHeight);
      }
    });
    ...
    player.stream.error.listen((event) {
      debugPrint("�7�2�1�5 Player Error: $event");
  ...
  // �7�3 FIXED: Manual Fullscreen Logic using SystemChrome
    ...
    if (_isFullscreen) {
      ...
      if (_lastWidth > 0 && _lastHeight > 0) {
        if (_lastWidth >= _lastHeight) {
          ...
          // Portrait Video (Shorts/TikTok style)
          await SystemChrome.setPreferredOrientations([DeviceOrientation.portraitUp]);
        }
      } else {
        // Default fallback if dimensions unknown
        await SystemChrome.setPreferredOrientations([DeviceOrientation.landscapeLeft, DeviceOrientation.landscapeRight]);
      }
  ...
  void dispose() {
    ...
    // �7�3 Safety: Always reset UI on dispose
              ...
              if (_isError)
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.wifi_off_rounded, color: Colors.redAccent, size: constraints.maxWidth * 0.15),
                      const SizedBox(height: 12),
                      Text("�1�8�1�6�1�7 �1�9�1�0�1�6�1�5�1�7 �1�7�1�2�1�3�1�9�1�8 �1�0�1�9�1�8�1�5�1�0�1�2�1�9�1�0�1�2", style: TextStyle(color: Colors.white, fontSize: constraints.maxWidth * 0.05)),
  ...
  Widget _controls() => Positioned(
      ...
      child: Container(
          ...
          child: SafeArea(top: false, child: Row(children: [
                ...
                const Spacer(),
                // �7�3 FIXED: Using manual toggle logic
