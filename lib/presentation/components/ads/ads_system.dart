              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(onTap: _openExternalBrowser, child: const Icon(Icons.public, color: Colors.amber, size: 24)),
                  ],
                ),
              ),
            ),
...
class _WebAdBannerState extends State<WebAdBanner> {
  ...
  @override void initState() {
    ...
    _msgListener = (web.Event event) {
      try {
        ...
        // ✅ RADICAL FIX 2: Explicitly documented intentional swallow
    ...
    _sub = Connectivity().onConnectivityChanged.listen((res) {
      ...
      } else if (!connected) { setState(() => _isConnected = false); }
    });
  }
  ...
  void _registerFluidFactory() {
    ...
    ui_web.platformViewRegistry.registerViewFactory(_viewId, (int viewId) {
      ...
      iframe.sandbox.add('allow-scripts'); iframe.sandbox.add('allow-same-origin'); iframe.srcdoc = content.toJS; return iframe;
    });
  }
