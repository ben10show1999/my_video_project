...
class _WebAdBannerState extends State<WebAdBanner> {
  ...
  void _registerFactory() {
    // ELASTIC GEOMETRY FIX: Inject CSS to force 100% width/height
    final content = """
      <html>
      <head>
        <style>
          body { margin: 0; padding: 0; overflow: hidden; width: 100%; height: 100%; display: flex; }
          iframe { width: 100%; height: 100%; border: none; object-fit: cover; display: block; }
        </style>
      </head>
      <body>
        ${widget.adScript}
    ...
    return SizedBox.expand(
      child: Stack(
        children: [
          ...
          // CLICK SHIELD: High priority buttons to intercept clicks
              ...
              child: Center(
                child: MouseRegion(
                  ...
                  child: GestureDetector(
                    behavior: HitTestBehavior.opaque, // CRITICAL: Catch event before Iframe
