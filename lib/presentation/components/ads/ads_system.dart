...
class FullscreenAdViewer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Content - Force Stretch (SizedBox.expand)
          Positioned.fill(
             child: WebAdBanner(
              adScript: adScript,
...
class _WebAdBannerState extends State<WebAdBanner> {
  ...
  void _registerFactory() {
    // FLUID CSS: width 100%, height 100%, object-fit: cover
    final content = """
      <html>
      <head>
        <style>
        ...
        children: [
          ...
          Positioned.fill(
            child: GestureDetector(
               behavior: HitTestBehavior.translucent, // Allows drag to bubble up, catches tap
               onTap: () {
                 if (widget.isInternal) return;
          ...
          // 2. Close Button (With PointerInterceptor)
