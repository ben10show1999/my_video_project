...
class FullscreenAdViewer extends StatelessWidget {
  ...
  // Note: We ignore width/height in fullscreen to force stretch
...
// --- Main Banner Widget (Elastic Stretch + Anti-Click-Jack) ---
...
class _WebAdBannerState extends State<WebAdBanner> {
  ...
  void _registerFactory() {
    // CSS to force content to STRETCH and fill container
    final content = """
      <html>
      <head>
        <style>
  ...
  @override
  Widget build(BuildContext context) {
    // FIX 1: Use SizedBox.expand to FORCE Fill/Stretch instead of shrinking
    return SizedBox.expand(
      child: Stack(
        children: [
          ...
          // FIX 2: Click Shielding - Ensure buttons catch events over iframe
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: const Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Text("Close AD ", style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.bold)),
