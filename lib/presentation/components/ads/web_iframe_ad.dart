import 'dart:js_interop'; // Task 14: Required for .toJS
import 'dart:ui_web' as ui;
import 'package:flutter/material.dart';
import 'package:web/web.dart' as web; // Task 14: Wasm Compatible
...
class _WebIframeAdState extends State<WebIframeAd> {
  ...
  void initState() {
    ...
    // Task 14: Strict Isolation via srcdoc
    ...
    ui.platformViewRegistry.registerViewFactory(_viewId, (int viewId) {
      final iframe = web.HTMLIFrameElement()
        ...
        ..style.height = '100%'
        ..style.border = 'none'
        ..srcdoc = fullHtml.toJS; // Correct Wasm Conversion
