  ...
  @override Widget build(BuildContext context) { 
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      LayoutBuilder(builder: (c, cs) {
        ...
        // 2:3 Ratio Height for Image + Text Space
        double posterHeight = itemWidth * 1.5; 
        double totalHeight = posterHeight + 50; 
        
        return SizedBox(height: totalHeight, child: ListView.separated(controller: _sc, scrollDirection: Axis.horizontal, padding: const EdgeInsets.symmetric(horizontal: 16), itemCount: _m.length + (_load ? 1 : 0), separatorBuilder: (_,__) => const SizedBox(width: 10), itemBuilder: (c, i) { 
          ...
          return InkWell(onTap: () {
             ...
             Navigator.push(context, MaterialPageRoute(builder: (_) => MovieDetailsScreen(movie: targetMovie)));
              ...
              // Universal Image includes AspectRatio 2:3 by default
