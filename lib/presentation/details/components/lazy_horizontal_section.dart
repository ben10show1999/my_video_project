  ...
  @override Widget build(BuildContext context) { 
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      LayoutBuilder(builder: (c, cs) {
        ...
        return SizedBox(height: (itemWidth * 1.5) + 65, child: ListView.separated(controller: _sc, scrollDirection: Axis.horizontal, padding: const EdgeInsets.symmetric(horizontal: 16), itemCount: _m.length + (_load ? 1 : 0), separatorBuilder: (_,_) => const SizedBox(width: 10), itemBuilder: (c, i) { 
