...
class _PlaylistSidebarState extends State<PlaylistSidebar> { 
  ...
  // Script for Playlist Ad (Same 300x250 script will fit thanks to FittedBox)
...
""";
  ...
  // FIX: Updated to correct WebAdBanner usage (Anti-Freeze included)
  if (_ad) Padding(padding: const EdgeInsets.all(8.0), child: SizedBox(height: 120, child: WebAdBanner(adScript: _playlistAdScript, width: 300, height: 250, onClose: () => setState(() => _ad = false)))),
