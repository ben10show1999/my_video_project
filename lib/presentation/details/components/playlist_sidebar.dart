...
""";
  ...
  // TASK 2: Fluid Ad Container (Height constrained for ListView, width infinite)
  if (_ad) 
    Container(
      width: double.infinity,
      height: 250, 
      padding: const EdgeInsets.all(8.0),
      child: WebAdBanner(adScript: _playlistAdScript, onClose: () => setState(() => _ad = false), isInternal: false, isInteractive: false)
    ),
