...
""";
  ...
  // Notice: WebAdBanner is moved inside _list() for Task 5!
  Expanded(child: _list())])); } 
  
  // ✅ Task 5: Inline Scrollable Ad integrated into ListView
  // ✅ Task 1: AlwaysScrollableScrollPhysics to prevent scroll trap
  Widget _list() => ListView.builder(
    ...
    itemBuilder: (c, i) { 
      ...
      return InkWell(onTap: () => widget.onEpisodeTap(e), child: Container(padding: const EdgeInsets.all(8), color: sel ? Colors.white10 : Colors.transparent, child: Row(children: [
        ...
        // ✅ Zero-Backend Lazy Thumbnail with Auto-Retry
