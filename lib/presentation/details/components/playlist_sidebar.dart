...
""";
  ...
  // ELASTIC AD: Container with dynamic height but full width (No AspectRatio)
  if (_ad) 
    Container(
      width: double.infinity,
      height: 250, // Height constraint for column, but width is fluid
      padding: const EdgeInsets.all(8.0),
      child: WebAdBanner(adScript: _playlistAdScript, width: double.infinity, height: double.infinity, onClose: () => setState(() => _ad = false))
    ),
