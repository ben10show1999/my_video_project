...
class _PlaylistSidebarState extends State<PlaylistSidebar> { 
  ...
  // Elastic Playlist Ad
  if (_ad) Padding(padding: const EdgeInsets.all(8.0), child: SizedBox(height: 150, width: double.infinity, child: WebAdBanner(adScript: _playlistAdScript, width: double.infinity, height: double.infinity, onClose: () => setState(() => _ad = false)))),
