...
""";
  ...
  // ELASTIC AD: Expanded in column
  if (_ad) 
    Expanded(flex: 2, child: Padding(padding: const EdgeInsets.all(8.0), child: WebAdBanner(adScript: _playlistAdScript, width: double.infinity, height: double.infinity, onClose: () => setState(() => _ad = false)))),
