...
class _PlaylistSidebarState extends State<PlaylistSidebar> { 
  ...
  // Task 13: Ad inside Playlist with geometric containment
  if (_ad) Padding(padding: const EdgeInsets.all(8.0), child: StubbornAdContainer(adAspectRatio: 320/100, onClose: () => setState(() => _ad = false), simpleContent: Image.network("https://via.placeholder.com/320x100", fit: BoxFit.cover))), Expanded(child: _list())])); } 
