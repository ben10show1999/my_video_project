...
""";
  ...
  if (_ad) Padding(padding: const EdgeInsets.all(8.0), child: SizedBox(height: 100, child: WebAdBanner(adScript: _playlistAdScript, width: 300, height: 90, onClose: () => setState(() => _ad = false)))),
