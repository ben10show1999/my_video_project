...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> { 
  ...
  Widget _buildPlayerInstance() {
    return SmartMediaKitPlayer(
      ...
      videoId: "${widget.movie.id}_${_ep.id}", // Required for Persistent Resume
      totalDuration: const Duration(minutes: 45), // Mock duration, bypasses live stream check
      thumbnailUrl: _ep.thumbnailUrl, 
