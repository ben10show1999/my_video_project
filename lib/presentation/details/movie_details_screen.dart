...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> { 
  ...
  Widget _buildPlayerInstance() {
    bool isLive = _ep.duration == "0:00"; 
    return SmartMediaKitPlayer(
      key: _playerKey, videoId: _ep.id, sources: _ep.sources, videoTitle: "${widget.movie.title} - ${_ep.title}", isLive: isLive,
      thumbnailUrl: _ep.thumbnailUrl, onAspectRatioChanged: _updateLayoutForVideo, isFullscreen: _isFullscreen, onFullscreenToggle: () => setState(() => _isFullscreen = !_isFullscreen),
    );
  }
