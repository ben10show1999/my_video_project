...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> { 
  ...
  // Task 27 & 33: Fluid Geometry & Description Fix for Desktop
  Widget _desk(AppProvider p) { 
    return LayoutBuilder(builder: (context, constraints) { 
      // Calculate Width based on Aspect Ratio to avoid empty space
      double availableHeight = MediaQuery.of(context).size.height * 0.7; // Max height target
      ...
      return SingleChildScrollView(child: Padding(padding: const EdgeInsets.all(24), child: Column(children: [
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          SizedBox(width: calculatedPlayerWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            _info(false, p),
            const SizedBox(height: 20),
            // Task 33: Ensure description is here and not hidden
            Text(p.tr('overview'), style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)), 
