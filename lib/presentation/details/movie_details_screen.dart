...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> { late ScrollController _sc; late MovieModel _mov; late SeasonModel _sea; late EpisodeModel _ep; @override void initState() { super.initState(); _sc = ScrollController(); _data(); } 
  ...
  void _data() { 
    ...
    _mov = MovieModel(id: 1, title: "Flutter Mastery", overview: "An epic journey into Dart & Flutter.", posterPath: "", seasons: [
      ...
      SeasonModel(id: "s3", title: "Season 3", episodes: List.generate(3, (i) => EpisodeModel(id: "s3e$i", title: "S3 Ep ${i+1}", duration: "45:00", seasonNumber: 3, episodeNumber: i+1, sources: [VideoQualityModel(quality: "1080p", urls: [url1])])))
    ]); 
        ...
        Padding(
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Expanded(flex: 3, child: Column(children: [
              SmartMediaKitPlayer(sources: _ep.sources), 
              const SizedBox(height: 20), 
              _info(false)
            ])), 
            const SizedBox(width: 24), 
            Expanded(flex: 1, child: Column(children: [
              // PlaylistSidebar now behaves correctly inside this Column (No Expanded)
