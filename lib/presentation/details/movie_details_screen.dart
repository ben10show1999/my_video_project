...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> { 
  ...
  Widget _buildPlayerInstance() {
    return SmartMediaKitPlayer(
      key: _playerKey, sources: _ep.sources, videoTitle: "${widget.movie.title} - ${_ep.title}",
  ...
  Widget _mob(AppProvider p) => SingleChildScrollView(controller: _sc, child: Column(children: [
    if (_isFullscreen) AspectRatio(aspectRatio: _currentAspectRatio, child: Container(color: Colors.black)) else AspectRatio(aspectRatio: _currentAspectRatio, child: _buildPlayerInstance()), 
