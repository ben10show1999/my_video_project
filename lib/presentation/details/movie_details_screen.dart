...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> { 
  ...
  double _currentAspectRatio = 16/9; // Task 31 & 32
  ...
  // Task 32: Synchronized Update for fluid layout
  ...
  Widget _buildPlayerInstance() {
    return SmartMediaKitPlayer(
      ...
      onAspectRatioChanged: _updateLayoutForVideo, // Callback triggers fluid layout
  ...
  // Task 32: Mobile Fluid Layout (Vertical Stack expands based on height)
  ...
  // Task 32: Desktop Fluid Layout (Flex Constraints synchronize Player width and Playlist size without distortion)
  Widget _desk(AppProvider p) { 
    return LayoutBuilder(builder: (context, constraints) { 
      // Calculate Flex proportions. Standard 16/9 is ~ 1.77. 
      // If ratio < 1.0 (vertical video), player gets less flex, playlist gets more.
      ...
      return SingleChildScrollView(child: Padding(padding: const EdgeInsets.all(24), child: Column(children: [
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if(widget.movie.seasons.isNotEmpty) Expanded(flex: listFlex, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            // The sidebar height mimics the calculated player height organically
