...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> { 
  ...
  void _data() { 
    ...
    _mov = MovieModel(id: 1, title: "Flutter Mastery: The Complete Guide", overview: "This is a detailed overview of the series. It is long enough to trigger the expandable text widget. It demonstrates how the layout handles large blocks of text without breaking the UI symmetry.", posterPath: "", seasons: [
  ...
  // �7�3 FIXED: Symmetrical Layout (Player/Info LEFT -- Playlist/Overview RIGHT)
  Widget _desk() {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // Right Column: Playlist + Overview (Perfect Alignment)
                  Expanded(flex: listFlex, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    PlaylistSidebar(isDesktop: true, maxHeight: playlistMaxHeight, seasons: _mov.seasons, currentSeason: _sea, currentEpisode: _ep, onSeasonChanged: (s) => setState(() => _sea = s), onEpisodeTap: (e) => setState(() => _ep = e), isLoadingMore: false, onLoadMore: (){}),
                    const SizedBox(height: 24), 
                    const Text("Overview", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 8),
                    _over() // Overview moves here for desktop symmetry
                  ]))
                ]
              ),
            ),
