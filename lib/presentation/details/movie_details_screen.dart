              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(flex: listFlex, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    PlaylistSidebar(isDesktop: true, maxHeight: playlistMaxHeight, seasons: widget.movie.seasons, currentSeason: _sea, currentEpisode: _ep, onSeasonChanged: (s) => setState(() => _sea = s), onEpisodeTap: (e) => setState(() => _ep = e), isLoadingMore: false, onLoadMore: (){}),
