...
class _MovieDetailsScreenState extends State<MovieDetailsScreen> { 
  ...
  // Task 16: Elastic Aspect Ratio State
  ...
  // Task 16: Update Layout when video size changes
  ...
  // Task 17: Symbiotic Layout Logic (Inverse Width Calculation)
  Widget _desk(AppProvider p) { return LayoutBuilder(builder: (context, constraints) { 
    ...
    return SingleChildScrollView(child: Padding(padding: const EdgeInsets.all(24), child: Column(children: [Row(crossAxisAlignment: CrossAxisAlignment.start, children: [SizedBox(width: playerWidth, child: Column(children: [SizedBox(height: playerHeight, child: SmartMediaKitPlayer(sources: _ep.sources, onAspectRatioChanged: _updateLayoutForVideo)), const SizedBox(height: 20), _info(false, p)])), const SizedBox(width: 24), SizedBox(width: listWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      // Height Sync: List height = Player height
