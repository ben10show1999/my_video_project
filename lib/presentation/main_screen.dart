...
class _MainScreenState extends State<MainScreen> {
  // Task 14: Cache Futures to prevent Keyboard from destroying deferred views
  ...
  @override void initState() { 
    super.initState(); 
    _homeFuture = home_tab.loadLibrary(); _searchFuture = search_tab.loadLibrary();
    _listFuture = list_tab.loadLibrary(); _settingsFuture = settings_tab.loadLibrary();
  }
