...
import 'package:my_video_project/presentation/main_screen.dart' deferred as main_sc;

void main() { 
  WidgetsFlutterBinding.ensureInitialized(); MediaKit.ensureInitialized(); 
...
class MyApp extends StatelessWidget { 
  ...
  @override Widget build(BuildContext context) { 
    ...
    return MaterialApp(
      debugShowCheckedModeBanner: false, title: 'Video Project', locale: p.locale,
      ...
      home: FutureBuilder(future: main_sc.loadLibrary(), builder: (c, s) => s.connectionState == ConnectionState.done ? main_sc.MainScreen() : const Scaffold(backgroundColor: Colors.black))
    ); 
  } 
}
