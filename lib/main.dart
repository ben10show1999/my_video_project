...
void main() async { 
  ...
  try {
    ...
    // 💡 VAPID Key لضمان استلام التوكن في بيئة الويب المباشرة
    ...
    if (!kIsWeb) {
      ...
      // 🔥 FIX 1 & 3: تم تحويل الإعدادات إلى Named Parameter 'settings:'
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async { 
      ...
      if (!kIsWeb && message.notification != null) {
        ...
        // 🔥 FIX 2 & 4: تم تحويل المعاملات إلى Named Parameters لدالة show
        _fln.show(
    ...
    try { await FirebaseMessaging.instance.subscribeToTopic('all_users'); } catch (_) { /* Bypassed on pure Web */ }
