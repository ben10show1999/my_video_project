...
window.startAudioPipeline = function(videoUrl, targetLang) {
    if (!aiWorker) {
        ...
        aiWorker.onmessage = (e) => { window.dispatchEvent(new CustomEvent('ai_bridge_msg', { detail: e.data })); };
