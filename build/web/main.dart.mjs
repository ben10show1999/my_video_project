...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1319: (x0,x1) => ({body: x0,icon: x1}),
      _1320: (x0,x1) => new Notification(x0,x1),
      _1328: x0 => x0.load(),
      _1329: x0 => x0.remove(),
      _1330: (x0,x1) => x0.getContext(x1),
      _1331: (x0,x1,x2,x3,x4,x5) => x0.drawImage(x1,x2,x3,x4,x5),
      _1332: (x0,x1,x2) => x0.toDataURL(x1,x2),
      _1333: (x0,x1) => x0.getItem(x1),
      _1335: (x0,x1,x2) => x0.setItem(x1,x2),
      _1336: (x0,x1) => x0.appendChild(x1),
      _1337: (x0,x1) => x0.querySelector(x1),
      _1338: Date.now,
      ...
      _1357: x0 => new FinalizationRegistry(x0),
      _1359: (x0,x1,x2) => x0.register(x1,x2),
      _1362: () => globalThis.WeakRef,
      _1363: () => globalThis.FinalizationRegistry,
      ...
      _6283: x0 => x0.documentElement,
      _6306: x0 => x0.head,
      _6317: x0 => x0.hidden,
      _6634: x0 => x0.id,
      _6635: (x0,x1) => { x0.id = x1 },
      _6659: (x0,x1) => { x0.innerHTML = x1 },
      _7980: x0 => x0.value,
      _7982: x0 => x0.done,
      _8405: () => globalThis.Notification.permission,
      _8683: x0 => x0.url,
      _8685: x0 => x0.status,
