...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1298: x0 => x0.call(),
      _1299: (x0,x1) => ({body: x0,icon: x1}),
      _1300: (x0,x1) => new Notification(x0,x1),
      ...
      _1320: (x0,x1) => x0.removeAttribute(x1),
      _1325: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1326: () => globalThis.Notification.requestPermission(),
      _1327: (x0,x1,x2) => x0.setItem(x1,x2),
      _1331: x0 => globalThis.firebase_remote_config.fetchAndActivate(x0),
      _1338: (x0,x1) => globalThis.firebase_remote_config.getString(x0,x1),
      _1349: x0 => globalThis.firebase_remote_config.getRemoteConfig(x0),
      _1360: x0 => x0.toArray(),
      _1361: x0 => x0.toUint8Array(),
      _1362: x0 => ({serverTimestamps: x0}),
      _1366: x0 => new firebase_firestore.FieldPath(x0),
      _1367: (x0,x1) => new firebase_firestore.FieldPath(x0,x1),
      _1368: (x0,x1,x2) => new firebase_firestore.FieldPath(x0,x1,x2),
      _1369: (x0,x1,x2,x3) => new firebase_firestore.FieldPath(x0,x1,x2,x3),
      _1370: (x0,x1,x2,x3,x4) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4),
      _1371: (x0,x1,x2,x3,x4,x5) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5),
      _1372: (x0,x1,x2,x3,x4,x5,x6) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6),
      _1373: (x0,x1,x2,x3,x4,x5,x6,x7) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6,x7),
      _1374: (x0,x1,x2,x3,x4,x5,x6,x7,x8) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6,x7,x8),
      _1375: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9) => new firebase_firestore.FieldPath(x0,x1,x2,x3,x4,x5,x6,x7,x8,x9),
      _1376: () => globalThis.firebase_firestore.documentId(),
      _1377: (x0,x1) => new firebase_firestore.Timestamp(x0,x1),
      _1378: (x0,x1) => new firebase_firestore.GeoPoint(x0,x1),
      _1379: x0 => globalThis.firebase_firestore.vector(x0),
      _1380: x0 => globalThis.firebase_firestore.Bytes.fromUint8Array(x0),
      _1382: (x0,x1) => globalThis.firebase_firestore.collection(x0,x1),
      _1384: (x0,x1) => globalThis.firebase_firestore.doc(x0,x1),
